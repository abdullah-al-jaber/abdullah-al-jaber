...
sed -i '9d' ~/.config/starship.toml
sed -i '9d' ~/.config/starship.toml
sed -i '9d' ~/.config/starship.toml
sed -i '2i scan_timeout = 0' ~/.config/starship.toml
sed -i '18i' ~/.config/starship.toml
sed -i '19i [character]' ~/.config/starship.toml
sed -i '19i disabled = false' ~/.config/starship.toml
sed -i "19i success_symbol = '[❯](blue)'" ~/.config/starship.toml
sed -i "19i error_symbol = '[❯](red)'" ~/.config/starship.toml
sed -i '19i' ~/.config/starship.toml
