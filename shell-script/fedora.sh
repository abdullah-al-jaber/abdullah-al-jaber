...
sudo -u retro-boy zsh -c "sed -i "s/plugins=(git)/plugins=(git zsh-syntax-highlighting zsh-autosuggestions zsh-eza)/g" ~/.zshrc"
sudo -u retro-boy zsh -c "sudo dnf copr enable alternateved/eza"
